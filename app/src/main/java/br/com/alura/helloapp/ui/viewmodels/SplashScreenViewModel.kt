...
import br.com.alura.helloapp.localData.preferences.PreferencesKey.LOGADO
...
@HiltViewModel
class SplashScreenViewModel @Inject constructor(private val dataStore: DataStore<Preferences>): ViewModel() {
